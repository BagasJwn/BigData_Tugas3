...
- yang pertama membaca data dari file yang sudah di download dari file terlampir. yang dibaca hanya <br/>
  movies.csv<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/file_reader.PNG "file reader")<br>

- dengan melakukan konfigurasi seperti ini, dengan memastikan movieID terbaca<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/file_reader_conf.PNG "file reader conf")<br>

- dari ini kita melakukan konfigurasi di dalam node add fields untuk menambahkan userid dan timestamp.<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/add_fields.PNG "add field")<br>

- di dalam add field terdapat workflow yang dapat menyeting userid dan timestamp<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/node_add_fields.PNG "add field")<br>

- melakukan konfigurasi di dalam node constant value untuk menyeting timestamp dan node selanjutnya untuk menyeting 
  userid<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/node_timestamp.PNG "add field")
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/timestamp.PNG "add field")<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/node_userid.PNG "add field")
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/userid.PNG "add field")<br>
...
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/row_splitter.PNG "add field")<br>

- melakukan konfigurasi di dalam row splitter seperti ini<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/row_splitter_conf.PNG "add field")<br>

- open vie node tersebut untuk melihat hasilnya<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/node_rating.PNG "add field")<br>

- hasil rating didapati seperti ini, dengan keterangan tertera pada gambar, hasil ini sesuai dengan userid yang <br/>
  disetting<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/hasil_ratings.PNG "add field")<br>

### File Reader versi SPARK

- memulai dengan memasang node local big data environment untuk disambung ke node spark<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/local_bigdata.PNG "add field")<br>

- pastikan konfigurasi seperti ini<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/conf_local_bigdata.PNG "add field")<br>

- sambungkan local environment big data dengan spark, sehingga dapat membaca file dari directory yang tertera<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/spark.PNG "add field")
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/conf_spark.PNG "add field")<br>
...
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/partition.PNG "add field")<br>

- pastikan memilih persen dan memilih draw randomly.<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/conf_partition.PNG "add field")<br>
...
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/model.PNG "add field")<br>

# Evaluation

- data yang sudah diprediksi berupa seperti ini
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/hasilprediksi.PNG "add field")<br>
...
- dari data yang sudah di modeling dan dari proses evaluasi ini menghapus juga data NAN.setalah itu terdapat hasil<br>
 ...
 ![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/evaluation.PNG "add field")<br>
 
 - didapati hasil evaluasi dari percobaan seperti berikut<br>
  ![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/hasil_prediksi.PNG "add field")<br>
 

# Deployment

- workflow ini akan mendisplay 10 peringkat prediksi film rekomendasi<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/deploy.PNG " asli csv")<br/>

### konfigurasi node top 20
- tidak lupa menjalankan file reader untuk di join dengan file prediksi<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/deploy_read.PNG " asli csv")<br/>

- jalankan spark predictor dan akan mendapati hasil seperti ini<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/spark_deploy.PNG " asli csv")<br/>
...
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/recom.PNG " asli csv")<br/>

- row filter disini untuk menghapus hasil prediksi yang hasilnya NAN<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/row_predik.PNG " asli csv")<br/>

- dan untuk mengurutkan data hasilnya dipilih ascending untuk nilai kolom prediction<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/asc.PNG " asli csv")<br/>
...
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/best.PNG " asli csv")<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/excel.PNG " asli csv")<br/>

## hasil deploy
- hasil yang didapati adalah sebagai berikut sesuai dengan arahan untuk memberi best 10 movie<br>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/hasil_done.PNG " asli csv")<br/>

# susunan KNIME
susunan KNIME seperti berikut
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/arsitek.PNG " asli csv")<br/>
...
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/timer.PNG " asli csv")<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/konfi.PNG " asli csv")<br/>

- perbedaan data sebagai berikut<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/spark_time.PNG " asli csv")<br/>
![alt text](https://github.com/BagasJwn/BigData_Tugas3/blob/master/tugas_3/picture/read_time.PNG " asli csv")<br/>
